      ...
      <div class="col-md-6 col-xs-12 col-lg-6 col-sm-6 col-">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
              ...
              <div>
                <form method="post" action="castEnter/{{$candidate->id}}/{{$portfolio->id}}/{{session()->get('vid')}}">
                	{{csrf_field()}}
                  <input type="submit" name="Vote" class="btn btn-success" value="YES"/>
                  <a href="castNoEnter/{{$candidate->id}}/{{$portfolio->id}}/{{session()->get('vid')}}"><span class="btn btn-danger" value="NO">NO</span></a>
